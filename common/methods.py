...
class TemperatureMethod:
    """ Obtaining information about the state of the temperature sensor """
    GET_SENSOR_INFO = "temp.sensor.info.get"
    GET_GROUP_INFO = "temp.group.info.get"
    GET_SENSOR_ALARM = "temp.sensor.alarm_temp.get"
    GET_SENSOR_STATUS = "temp.sensor.status.get"
    GET_LATEST_CHANGES_SENSOR = "temp.sensor.latest_measurement.get"
